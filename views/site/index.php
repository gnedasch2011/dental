                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="widget text-white">
                            <i class="fa fa-clock-o text-white"></i> Opening Hours: Mon - Tues :
                        ...
                        <div class="header-widget-contact-info-box sm-text-center">
                            ...
                            <div class="media element contact-info">
                                ...
                                <div class="media-body">
                                    ...
                                    <h5 class="media-heading subtitle">121 King Street,
                                        Melbourne</h5>
                                </div>
                            </div>
                        </div>
                    ...
                    <nav id="menuzord" class="menuzord blue no-bg">
                        <div class="pull-right sm-pull-left mb-sm-15">
                            <a class="btn btn-colored btn-flat btn-theme-colored mt-15 mt-sm-10 pt-10 pb-10 ajaxload-popup"
                               href="ajax-load/form-appointment.html">Register Now</a>
                        </div>
                                    ...
                                    <div class="top-nav-mini-cart-icon-contents">
                                        <a class="mini-cart-icon" href="#"
                                           title="View your shopping cart"><i
                                            ...
                                            <span class="cart-quick-info">2 items - <span
                                        ...
                                        <div class="dropdown-content">
                                            <div class="dropdown-content-wrapper">
                                                <ul class="woocommerce-mini-cart cart_list product_list_widget ">
                                                    <li class="woocommerce-mini-cart-item mini_cart_item">
                                                        <a href="#" class="remove"
                                                           ...
                                                           data-product_sku="">×</a>
                                                        <a href="#"><img
                                                                    src="http://placehold.it/68x68"
                                                                    alt="" width="68">Happy Ninja&nbsp;</a>
                                                ...
                                                <div class="woocommerce-mini-cart__total total cart-subtotal">
                                                    Subtotal: <span><span
                                                                class="woocommerce-Price-amount amount"><span
                        ...
                        <ul class="menuzord-menu">
                            <li class="active"><a href="#home">Home</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="#">Boxed Layouts</a>
                                        <ul class="dropdown">
                                            <li><a href="index-boxed-mp-layout1.html">Multipage
                                                    Layout1</a></li>
                                            <li><a href="index-boxed-mp-layout2.html">Multipage
                                                    Layout2</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="#">Hot Layouts</a>
                                        <ul class="dropdown">
                                            <li><a href="index-hot-parallax-layout1.html">Hot
                                                    Parallax Layout</a></li>
                                            <li><a href="index-hot-slider-fullpage-layout1.html">Hot
                                                    Fullpage Slider Layout</a></li>
                                            <li><a href="index-hot-slider-pagepiling-layout1.html">Hot
                                                    Slider Pagepiling Layout</a></li>
                                            <li><a href="index-hot-slider-split-home-layout1.html">Hot
                                                    Slider Split Layout</a></li>
                                            <li>
                                                <a href="index-hot-vertical-rev-slider-home-layout1.html">Hot
                                                    Vertical Rev Slider Layout</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Home Variations</a>
                                        <ul class="dropdown">
                                            <li><a href="#">Rev Slider</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="index-home-variation-revslider-style1.html">Layout1</a>
                                                    </li>
                                                    <li>
                                                        <a href="index-home-variation-revslider-style2.html">Layout2</a>
                                                    </li>
                                                    <li>
                                                        <a href="index-home-variation-revslider-style3.html">Layout3</a>
                                                    </li>
                                                    <li>
                                                        <a href="index-home-variation-revslider-style4.html">Layout4</a>
                                                    </li>
                                                    <li>
                                                        <a href="index-home-variation-revslider-style5.html">Layout5</a>
                                                    </li>
                                                    <li>
                                                        <a href="index-home-variation-revslider-style6.html">Layout6</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            ...
                                            <li><a href="index-home-variation-owl-carousel.html">Owl
                                                    Carousel</a></li>
                                            <li>
                                                <a href="index-home-variation-owl-image-slider.html">Owl
                                                    Image Slider</a></li>
                                            <li><a href="index-home-variation-typed-text.html">Typed
                                                    Text Layout</a></li>
                                            <li>
                                                <a href="index-home-variation-video-background.html">Youtube
                                                    Background Video</a></li>
                                            <li><a href="index-home-variation-html5-video.html">Html5
                                                    Background Video</a></li>
                                            <li>
                                                <a href="index-home-variation-bg-image-parallax.html">Bg
                            ...
                            <li><a href="#">Features</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="#">Layout Variations</a>
                                        <ul class="dropdown">
                                            <li><a href="#">Boxed Layout</a>
                                                <ul class="dropdown">
                                                    <li><a href="features-index-boxed-layout1.html">Layout
                                                            1</a></li>
                                                    <li><a href="features-index-boxed-layout2.html">Layout
                                                            2</a></li>
                                                    <li><a href="features-index-boxed-layout3.html">Layout
                                                            3</a></li>
                                                    <li><a href="features-index-boxed-layout4.html">Layout
                                                            4</a></li>
                                                    <li><a href="features-index-boxed-layout5.html">Layout
                                                            5</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">RTL Layout</a>
                                                <ul class="dropdown">
                                                    <li><a href="features-index-rtl-layout1.html">Layout
                                                            1</a></li>
                                                    <li>
                                                        <a href="features-index-rtl-layout2-boxed.html">Layout
                                                            2 - Boxed</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    ...
                                    <li><a href="#">Header</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="features-header-style7.html">Header
                                                    Style7</a></li>
                                            <li><a href="features-header-style8.html">Header
                                                    Style8</a></li>
                                            <li><a href="features-header-style9.html">Header
                                                    Style9</a></li>
                                            <li><a href="features-header-style10-logo-middle.html">Header
                                                    Style10 - Logo Middle</a></li>
                                            <li>
                                                <a href="features-header-style11-logo-centered.html">Style11
                                                    - Logo Centered</a></li>
                                            <li>
                                                <a href="features-header-style12-logo-centered-transparent.html">Style12
                                                    - Logo Centered Transparent</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Header Modern <span class="label label-success">New</span></a>
                                        <ul class="dropdown">
                                            <li><a href="#">Style 1</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style1.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style1-white.html">White</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style1-theme-colored.html">Theme
                                                            Colored</a></li>
                                                    <li>
                                                        <a href="features-header-modern-style1-side-panel.html">Side
                                                            Push Panel</a></li>
                                                    <li>
                                                        <a href="features-header-modern-style1-side-panel2.html">Side
                                                            Push Panel 2</a></li>
                                                    <li>
                                                        <a href="features-header-modern-style1-contact-info-box.html">With
                                                            Contact Info Box</a></li>
                                                    <li>
                                                        <a href="features-header-modern-style1-contact-info-box-small.html">With
                                                            Contact Info Box Small</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Style 2</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style2.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style2-white.html">White</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style2-theme-colored.html">Theme
                                                            Colored</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Style 3</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style3.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style3-white.html">White</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style3-theme-colored.html">Theme
                                                            Colored</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Style 4</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style4.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style4-white.html">White</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style4-theme-colored.html">Theme
                                                            Colored</a></li>
                                                    <li>
                                                        <a href="features-header-modern-style4-theme-colored2.html">Theme
                                                            Colored2</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Style 5</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style5.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style5-white.html">White</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Style 6</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style6.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style6-white.html">White</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style6-theme-colored.html">Theme
                                                            Colored</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Style 7</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style7.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style7-white.html">White</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style7-theme-colored.html">Theme
                                                            Colored</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Style 8</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="features-header-modern-style8.html">Dark</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style8-white.html">White</a>
                                                    </li>
                                                    <li>
                                                        <a href="features-header-modern-style8-theme-colored.html">Theme
                                                            Colored</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Header Floating <span
                                                    class="label label-success">New</span></a>
                                        <ul class="dropdown">
                                            <li><a href="features-header-floating-header1.html">Sample
                                                    1</a></li>
                                            <li><a href="features-header-floating-header2.html">Sample
                                                    2</a></li>
                                            <li><a href="features-header-floating-header3.html">Sample
                                                    3</a></li>
                                            <li><a href="features-header-floating-header4.html">Sample
                                                    4</a></li>
                                            <li><a href="features-header-floating-header5.html">Sample
                                                    5</a></li>
                                            <li><a href="features-header-floating-header6.html">Sample
                                                    6</a></li>
                                            <li><a href="features-header-floating-header7.html">Sample
                                                    7</a></li>
                                            <li><a href="features-header-floating-header8.html">Sample
                                                    8</a></li>
                                            <li><a href="features-header-floating-header9.html">Sample
                                                    9</a></li>
                                            <li><a href="features-header-floating-header10.html">Sample
                                                    10</a></li>
                                            <li><a href="features-header-floating-header11.html">Sample
                                                    11</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Header Search Form</a>
                                        <ul class="dropdown">
                                            <li>
                                                <a href="features-header-search-form-style1-fullscreen.html">Fullscreen
                                                    Search</a></li>
                                            <li>
                                                <a href="features-header-search-form-style2-inline-fullwidth.html">Inline
                                                    Fullwidth Search</a></li>
                                            <li>
                                                <a href="features-header-search-form-style3-inline-fullwidth-dropdown.html">Inline
                                                    Fullwidth Dropdown</a></li>
                                            <li>
                                                <a href="features-header-search-form-style4-from-top-dropdown.html">Top
                                                    Dropdown</a></li>
                                            <li>
                                                <a href="features-header-search-form-style5-pushdown-from-top.html">Pushdown
                                                    From Top</a></li>
                                            <li>
                                                <a href="features-header-search-form-style6-dropdown.html">Dropdown</a>
                                            </li>
                                            <li>
                                                <a href="features-header-search-form-style7-searchbox.html">Simple
                                                    Search Box</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Page Title</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="features-page-title-big-version.html">Big
                                                    Version</a></li>
                                            <li>
                                                <a href="features-page-title-extra-big-version.html">Extra
                                                    Big Version</a></li>
                                            ...
                                            <li><a href="features-page-title-bg-image.html">Bg
                                                    Image</a></li>
                                            <li>
                                                <a href="features-page-title-bg-image-parallax.html">Bg
                                                    Image Parallax</a></li>
                                    ...
                                    <li><a href="#">Side Push Panel</a>
                                        <ul class="dropdown">
                                            <li>
                                                <a href="features-side-push-panel-left-overlay.html">Left
                                                    Overlay</a></li>
                                            <li><a href="features-side-push-panel-left-push.html">Left
                                                    Push</a></li>
                                            <li>
                                                <a href="features-side-push-panel-right-overlay.html">Right
                                                    Overlay</a></li>
                                    ...
                                    <li><a href="#">Form</a>
                                        <ul class="dropdown">
                                            <li><a href="#">Subscribe Form</a>
                                                <ul class="dropdown">
                                                    <li><a href="form-subscribe.html">Form style
                                                            1</a></li>
                                                </ul>
                                            </li>
                                    ...
                                    <li><a href="#">Paypal Form <span class="label label-success">New</span></a>
                                        <ul class="dropdown">
                                            <li><a href="#">Donation Onetime</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="form-paypal-donate-onetime-style1.html">Style1</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-onetime-style2.html">Style2</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-onetime-style3.html">Style3</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-onetime-style4.html">Style4</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-onetime-style5.html">Style5</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-onetime-style6.html">Style6</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-onetime-style7.html">Style7</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Donation Recurring</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="form-paypal-donate-recurring-style1.html">Style1</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-recurring-style2.html">
                                                            Style2</a></li>
                                                    <li>
                                                        <a href="form-paypal-donate-recurring-style3.html">Style3</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-recurring-style4.html">Style4</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-recurring-style5.html">Style5</a>
                                                    </li>
                                                </ul>
                                            </li>
                                            <li><a href="#">Both Onetime/Recurring</a>
                                                <ul class="dropdown">
                                                    <li>
                                                        <a href="form-paypal-donate-both-onetime-recurring-style1.html">Style1</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-both-onetime-recurring-style2.html">Style2</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-both-onetime-recurring-style3.html">Style3</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-both-onetime-recurring-style4.html">Style4</a>
                                                    </li>
                                                    <li>
                                                        <a href="form-paypal-donate-both-onetime-recurring-style5.html">Style5</a>
                                                    </li>
                                                </ul>
                                            </li>
                                    ...
                                    <li><a href="#">Popup Promo Box</a>
                                        <ul class="dropdown">
                                            <li><a href="features-popup-promo-box.html">Default</a>
                                            </li>
                                            <li>
                                                <a href="features-popup-promo-box-cookie-enabled.html">Cookie
                                                    Enabled</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Footer</a>
                                        <ul class="dropdown">
                                            <li>
                                                <a href="features-footer-style10-fixed-footer.html#footer">Fixed
                                                    Footer</a></li>
                                            <li><a href="features-footer-style1.html#footer">Footer
                                                    One</a></li>
                                            <li><a href="features-footer-style2.html#footer">Footer
                                                    Two</a></li>
                                            <li><a href="features-footer-style3.html#footer">Footer
                                                    Three</a></li>
                                            <li><a href="features-footer-style4.html#footer">Footer
                                                    Four</a></li>
                                            <li><a href="features-footer-style5.html#footer">Footer
                                                    Five</a></li>
                                            <li><a href="features-footer-style6.html#footer">Footer
                                                    Six</a></li>
                                            <li><a href="features-footer-style7.html#footer">Footer
                                                    Seven</a></li>
                                            <li><a href="features-footer-style8.html#footer">Footer
                                                    Eight</a></li>
                                            <li><a href="features-footer-style9.html#footer">Footer
                                                    Nine</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li><a href="#">Pages</a>
                                <ul class="dropdown">
                                    ...
                                    <li><a href="#">Contact</a>
                                        <ul class="dropdown">
                                            <li><a href="page-contact1.html">Contact style 1</a>
                                            </li>
                                            <li><a href="page-contact2.html">Contact style 2</a>
                                            </li>
                                            <li><a href="page-contact3.html">Contact style 3</a>
                                            </li>
                                            <li><a href="page-contact4.html">Contact style 4</a>
                                            </li>
                                            ...
                                            <li><a href="page-contact7-google-recaptcha.html">Contact
                                                    7 - reCAPTCHA</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Gallery</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="page-gallery-3col-tiles.html">3 Columns
                                                    Tiles</a></li>
                                            <li><a href="page-gallery-4col-tiles.html">4 Columns
                                                    Tiles</a></li>
                                            <li><a href="page-gallery-masonry-tiles.html">Tiles
                                                    (2-10 Columns)</a></li>
                                            <li><a href="page-gallery-masonry-tiles-animation.html">Tiles
                                                    with Animation (2-10 Columns)</a></li>
                                            <li><a href="page-gallery-prettyphoto.html">Pretty Photo
                                                    Gallery</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Services</a>
                                        <ul class="dropdown">
                                            <li><a href="page-services1.html">Services Style 1</a>
                                            </li>
                                            <li><a href="page-services2.html">Services Style 2</a>
                                            </li>
                                    ...
                                    <li><a href="#">Departments</a>
                                        <ul class="dropdown">
                                            <li><a href="page-department1.html">Departments sytle
                                                    1</a></li>
                                            <li><a href="page-department2.html">Departments sytle
                                                    2</a></li>
                                            <li><a href="page-department-details.html">Departments
                                                    Details</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Team</a>
                                        <ul class="dropdown">
                                            <li><a href="page-team-style1.html">Team Style 1</a>
                                            </li>
                                            <li><a href="page-team-style2.html">Team Style 2</a>
                                            </li>
                                            <li><a href="page-team-member-details.html">Team Member
                                                    Details</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Pricing</a>
                                        <ul class="dropdown">
                                            <li><a href="page-pricing-style1.html">Pricing Style
                                                    1</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li><a href="#">Calender</a>
                                        <ul class="dropdown">
                                            <li><a href="page-calendar1.html">Calendar Style1</a>
                                            </li>
                                            <li><a href="page-calendar2.html">Calendar Style2</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Events</a>
                                            ...
                                            <li><a href="#">Events List</a>
                                                <ul class="dropdown">
                                                    ...
                                                    <li><a href="events-list-right-sidebar.html">List
                                                            Right Sidebar</a></li>
                                                    <li><a href="events-list-no-sidebar.html">List
                                                            No Sidebar</a></li>
                                                </ul>
                                            </li>
                                    ...
                                    <li><a href="#">Coming Soon</a>
                                        <ul class="dropdown">
                                            <li><a href="page-coming-soon-style1.html">style1</a>
                                            </li>
                                            <li><a href="page-coming-soon-style2.html">style2</a>
                                            </li>
                                            <li><a href="page-coming-soon-style3.html">style3</a>
                                            </li>
                                            <li><a href="page-coming-soon-style4.html">style4</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Under Construction</a>
                                        <ul class="dropdown">
                                            ...
                                            <li>
                                                <a href="page-under-construction-style3.html">style3</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                                ...
                                <ul class="dropdown">
                                    <li><a href="#">Blog Classic</a>
                                        <ul class="dropdown dropdown-left">
                                            <li><a href="blog-classic-no-sidebar.html">Blog Classic
                                                    No Sidebar</a></li>
                                            <li><a href="blog-classic-left-sidebar.html">Blog
                                                    Classic Left Sidebar</a></li>
                                            <li><a href="blog-classic-right-sidebar.html">Blog
                                                    Classic Right Sidebar</a></li>
                                            <li><a href="blog-classic-both-sidebar.html">Blog
                                                    Classic Both Sidebar</a></li>
                                            <li><a href="blog-classic-left-thumbs.html">Blog Classic
                                                    Left Thumbs</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Blog Grid</a>
                                        <ul class="dropdown dropdown-left">
                                            <li><a href="blog-grid-2-column.html">Blog Grid 2
                                                    Column</a></li>
                                            <li><a href="blog-grid-3-column.html">Blog Grid 3
                                                    Column</a></li>
                                            <li><a href="blog-grid-4-column.html">Blog Grid 4
                                                    Column</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Blog Masonry</a>
                                        <ul class="dropdown dropdown-left">
                                            <li><a href="blog-masonry-2-column.html">Blog Masonry 2
                                                    Column</a></li>
                                            <li><a href="blog-masonry-3-column.html">Blog Masonry 3
                                                    Column</a></li>
                                            <li><a href="blog-masonry-4-column.html">Blog Masonry 4
                                                    Column</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Blog Single</a>
                                        <ul class="dropdown dropdown-left">
                                            <li><a href="blog-single-no-sidebar.html">Blog Single No
                                                    Sidebar</a></li>
                                            <li><a href="blog-single-left-sidebar.html">Blog Single
                                                    Left Sidebar</a></li>
                                            <li><a href="blog-single-right-sidebar.html">Blog Single
                                                    Right Sidebar</a></li>
                                            <li><a href="blog-single-both-sidebar.html">Blog Single
                                                    Both Sidebar</a></li>
                                            <li><a href="blog-single-disqus-comments.html">Blog
                                                    Single Discuss Comments</a></li>
                                            <li><a href="blog-single-facebook-comments.html">Blog
                                                    Single Facebook Comments</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Blog Infinity Scroll</a>
                                        <ul class="dropdown dropdown-left">
                                            <li><a href="blog-extra-infinity-scroll.html">Blog
                                                    Infinity Scroll Default</a></li>
                                            <li><a href="blog-extra-infinity-scroll-lazyload.html">Blog
                                                    Infinity Scroll Lazyload</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Blog Timeline</a>
                                        <ul class="dropdown dropdown-left">
                                            <li><a href="blog-timeline.html">Blog Timeline
                                                    Default</a></li>
                                            <li><a href="blog-timeline-masonry.html">Blog Timeline
                                                    Masonry</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <li><a href="javascript:void(0)">Mega Menu</a>
                                <div class="megamenu megamenu-bg-img">
                                    <div class="megamenu-row">
                                        <div class="col3">
                                            ...
                                            <div class="widget">
                                                <div class="latest-posts">
                                                    <article
                                                            class="post media-post clearfix pb-0 mb-10">
                                                        <a href="blog-single-right-sidebar.html"
                                                           class="post-thumb"><img alt=""
                                                                                   src="http://placehold.it/80x55"></a>
                                                        <div class="post-right">
                                                            <h5 class="post-title mt-0 mb-5"><a
                                                                        href="blog-single-right-sidebar.html">Post
                                                                    Title Here</a></h5>
                                                            <p class="post-date mb-0 font-12">Mar
                                                                08, 2015</p>
                                                        </div>
                                                    </article>
                                                    <article
                                        ...
                                        <div class="col3">
                                            <h4 class="megamenu-col-title"><strong>Featured
                                                    News:</strong></h4>
                                            <article class="post clearfix">
                                                <div class="entry-header">
                                                    <div class="post-thumb"><img
                                                                class="img-responsive"
                                                                src="http://placehold.it/370x270"
                                                                alt=""></div>
                                                </div>
                                                <div class="entry-content">
                                                    <p class="">Lorem ipsum dolor sit amet,
                                                        ...
                                                        et sed aliqua</p>
                                                    <a class="btn btn-dark btn-theme-colored"
                                    ...
                                    <div class="megamenu-row">
                                        <div class="col3">
                                            <ul class="list-unstyled list-dashed">
                                                <li><a href="shortcode-accordion.html"><i
                                                                class="fa fa-list-ul"></i> Accordion</a>
                                                </li>
                                                ...
                                                <li><a href="shortcode-background-html5-video.html"><i
                                                        ...
                                                        HTML5
                                                        Background Video</a></li>
                                                <li><a href="shortcode-before-after-slider.html"><i
                                                                class="fa fa-window-restore"></i>
                                                        Before/After Slider</a></li>
                                                <li><a href="shortcode-blockquotes.html"><i
                                                                class="fa fa-quote-right"></i>
                                                        Blockquotes</a></li>
                                                <li><a href="shortcode-box-gradient-effect.html"><i
                                                                class="fa fa-picture-o"></i> Box
                                                        Gradient
                                                        Effects</a></li>
                                                <li><a href="shortcode-box-hover-effect.html"><i
                                                                class="fa fa-picture-o"></i> Box
                                                        Hover
                                                        Effects</a></li>
                                                <li>
                                                    <a href="shortcode-button-groups-and-dropdowns.html"><i
                                                ...
                                                <li><a href="shortcode-charts.html"><i
                                                                class="fa fa-pie-chart"></i> Charts</a>
                                                </li>
                                                <li><a href="shortcode-columns-grids.html"><i
                                                                class="fa fa-columns"></i> Columns
                                                        Grids</a>
                                                </li>
                                        ...
                                        <div class="col3">
                                            <ul class="list-unstyled list-dashed">
                                                ...
                                                <li>
                                                    <a href="shortcode-datetime-datetimepicker.html"><i
                                                ...
                                                <li><a href="shortcode-iconbox.html"><i
                                                                class="fa fa-unsorted"></i> Icon Box</a>
                                                </li>
                                                <li><a href="shortcode-icon-7stroke.html"><i
                                                                class="fa fa-circle-o"></i> Icons
                                                        7stroke</a></li>
                                                <li><a href="shortcode-icon-elegant-icons.html"><i
                                                                class="fa fa-eye-slash"></i> Icons
                                                        Elegant</a></li>
                                                <li>
                                                    <a href="shortcode-icon-flat-color-icons.html"><i
                                                                class="fa fa-i-cursor"></i> Icons
                                                        Flat
                                                        Color</a></li>
                                                <li><a href="shortcode-icon-fontawesome.html"><i
                                                        ...
                                                        FontAwesome</a></li>
                                                <li>
                                                    <a href="shortcode-icon-fontawesome-tutorial.html"><i
                                                                class="fa fa-fonticons"></i> Icons
                                                        FontAwesome Tutorial</a></li>
                                                <li><a href="shortcode-icon-strokegap.html"><i
                                                                class="strokegap-icon strokegap-icon-WorldWide"></i>
                                        ...
                                        <div class="col3">
                                            <ul class="list-unstyled list-dashed">
                                                ...
                                                <li><a href="shortcode-listgroup-panels.html"><i
                                                                class="fa fa-th-list"></i> Listgroup
                                                        Panels</a>
                                                </li>
                                                <li><a href="shortcode-lists.html"><i
                                                                class="fa fa-list"></i> Lists</a>
                                                </li>
                                                <li><a href="shortcode-maps.html"><i
                                                                class="fa fa-map-o"></i> Maps</a>
                                                </li>
                                                ...
                                                <li><a href="shortcode-progressbar.html"><i
                                                                class="fa fa-tasks"></i> Progress
                                                        Bars</a>
                                                </li>
                                                <li><a href="shortcode-piechart.html"><i
                                                                class="fa fa-sun-o"></i> Pie Charts</a>
                                                </li>
                                                <li><a href="shortcode-responsive.html"><i
                                                                class="fa fa-tablet"></i> Responsive</a>
                                                </li>
                                        ...
                                        <div class="col3">
                                            <ul class="list-unstyled list-dashed">
                                                ...
                                                <li><a href="shortcode-title.html"><i
                                                                class="fa fa-text-height"></i> Title</a>
                                                </li>
                                                <li>
                                                    <a href="shortcode-timer-final-countdown.html"><i
                                                                class="fa fa-text-height"></i> Timer
                                                        Final Countdown</a></li>
                            ...
                            <div class="icon-box iconbox-theme-colored2 left media p-0">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum
                                        consectetur sit ullam perspiciatis, deserunt.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 mb-30">
                            <div class="p-20 bg-white">
                                ...
                                <p class="">Lorem ipsum dolor sit amet, consectetur adipisicing elit
                                    tem autem voluptatem obcaecati.</p>
                                <a href="#"
                                   class="btn btn-flat btn-theme-colored mt-15 text-theme-color-2">Read
                                    More</a>
                            </div>
                        </div>
                ...
                <div class="call-to-action">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2 text-center">
                            <h2 class="text-white"><i class="pe-7s-call text-white"></i><a
                                        class="text-white" href="#"> (+01) &ndash; 234 567 890</a>
                            </h2>
                            <h2 class="text-white">Please free to contact us for emergency
                                case.</h2>
                            <p class="text-white">Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit rem autem voluptatem obcaecati lienum phaedrum
                                torquatos nec eu, vis detraxit periculis ex.</p>
                            <a href="#" class="btn btn-default btn-theme-colored2 mt-20">Contact
                                With Us</a>
                        </div>
                    </div>
                </div>
        ...
        <section class="bg-lighter">
            <div class="container">
                <div class="section-title text-center mt-0">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2 class="mt-0 line-height-1">Our <span class="text-theme-colored">Gallery</span>
                            </h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem
                                autem<br> voluptatem obcaecati!</p>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portfolio-filter text-center">
                                ...
                                <a href="#photography" class=""
                                   data-filter=".photography">Whitening</a>
                            </div>
                            ...
                            <div class="item">
                                <article class="post clearfix maxwidth600 mb-30 wow fadeInRight"
                                    ...
                                    <div class="entry-content bg-lighter p-20 pr-10">
                                        <div class="entry-meta mt-0 no-bg no-border">
                                            <div class="event-content">
                                                <h3 class="entry-title text-white text-capitalize m-0">
                                                    <a href="#">This is a standard post with
                                        ...
                                        <div class="mt-10"><a href="blog-single-left-sidebar.html"
                                                              class="btn btn-theme-colored btn-sm">Read
                                                More</a></div>
